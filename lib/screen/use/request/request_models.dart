...
List<HistoryStaff> historyStaffFromJson(String str) => List<HistoryStaff>.from(json.decode(str).map((x) => HistoryStaff.fromJson(x)));
...
class HistoryStaff {
  ...
  HistoryStaff.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    userId = json['user_id'];
